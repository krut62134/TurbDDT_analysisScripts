...
file = "/project/pi_rfisher1_umassd_edu/SNIa_turbDDT/kpatel29/runs/runs_autoddt_thermalreact/run_Torchex/tDDT_hdf5_part_001516"
print_data = get_data(file)

# Select only the posx, posy, posz, and tag columns (index 6, 7, 8, and 11 respectively)
selected_columns = print_data[0].iloc[:, [6, 7, 8, 11]]
