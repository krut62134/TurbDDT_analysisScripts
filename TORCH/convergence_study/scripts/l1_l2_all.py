...
files = {
    "e-1": "./1/out_*_final.dat",
    "e-2": "./2/out_*_final.dat",
    "e-3": "./3/out_*_final.dat",
    "e-4": "./4/out_*_final.dat",
    "e-5": "./5/out_*_final.dat",
    "e-6": "./6/out_*_final.dat",
    "e-7": "./7/out_*_final.dat",
    "e-8": "./8/out_*_final.dat"
}
